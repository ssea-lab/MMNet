...
if __name__ == "__main__":
    ...
    if not args.logfile_folder:
        args.logfile_folder = os.path.join(args.output, "logging")
    if not args.profile_folder:
        args.profile_folder = os.path.join(args.output, "profile")
    ...
    convert(
        ...
        glob.glob(os.path.join(args.input, "*.sketch"))[:20],
        # test_sketch,
        ConvertedSketchConfig(
            ...
            args.artboard_json,
            args.artboard_image,
            os.path.join(args.output, args.sketch_folder, args.config_file),
            os.path.join(args.output, args.sketch_folder)
        ),
        args.logfile_folder,
        args.profile_folder,
        args.threads
