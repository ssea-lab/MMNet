...
@dataclass
class DatasetConfig:
    # train_index_json: str = './sketch_dataset/data/train/index.json'
    # test_index_json: str = './sketch_dataset/data/test/index.json'
    train_index_json: str = './sketch_dataset/data/train-dataset/index_mini.json'
    test_index_json: str = './sketch_dataset/data/test-dataset/index_mini.json'
    # train_index_json: str = './sketch_dataset/data/Train-dataset/index.json'
    # test_index_json: str = './sketch_dataset/data/Test-dataset/index.json'
